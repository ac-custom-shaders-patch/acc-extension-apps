...
def acMain(ac_version):
    ...
    try:
        ...
        ac.setPosition(timeOffsetMinusSmallerButton, 8, 370)
        ac.setSize(timeOffsetMinusSmallerButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusSmallerButton, 58, 370)
        ac.setSize(timeOffsetPlusSmallerButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusSmallButton, 8, 385)
        ac.setSize(timeOffsetMinusSmallButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusSmallButton, 58, 385)
        ac.setSize(timeOffsetPlusSmallButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusBigButton, 8, 400)
        ac.setSize(timeOffsetMinusBigButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusBigButton, 58, 400)
        ac.setSize(timeOffsetPlusBigButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusHugeButton, 118, 370)
        ac.setSize(timeOffsetMinusHugeButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusHugeButton, 168, 370)
        ac.setSize(timeOffsetPlusHugeButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusMonthButton, 118, 385)
        ac.setSize(timeOffsetMinusMonthButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusMonthButton, 168, 385)
        ac.setSize(timeOffsetPlusMonthButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusYearButton, 118, 400)
        ac.setSize(timeOffsetMinusYearButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusYearButton, 168, 400)
        ac.setSize(timeOffsetPlusYearButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusPlaySmallButton, 228, 372)
        ac.setSize(timeOffsetMinusPlaySmallButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusPlaySmallButton, 278, 372)
        ac.setSize(timeOffsetPlusPlaySmallButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusPlayButton, 228, 385)
        ac.setSize(timeOffsetMinusPlayButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusPlayButton, 278, 385)
        ac.setSize(timeOffsetPlusPlayButton, 50, 14)
        ...
        ac.setPosition(timeOffsetMinusPlayBigButton, 228, 400)
        ac.setSize(timeOffsetMinusPlayBigButton, 50, 14)
        ...
        ac.setPosition(timeOffsetPlusPlayBigButton, 278, 400)
        ac.setSize(timeOffsetPlusPlayBigButton, 50, 14)
